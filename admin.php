...
<br>
 ...
 <a href="info.php"><img src="info.png"  width="40" height="40" style="border: 0" alt="O stronie."></a>
  ...
  <form action="login.php" method="post">
            <p>Ta zakładka służy do zarządzania treścią Blogu a także przesyłania skanlacji mang. Obie czynności wymagają podania poprawnego hasła.</p>
          	 <h3>Logowanie</h3>
            <p>Podaj haslo administratora w celu dokonania zmian.</p>
                <input type="password" name="haslo"/><br><br>
                <input type="submit" value="loguj" name="submit"/><br><br>
